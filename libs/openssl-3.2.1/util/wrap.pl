...
BEGIN {
    ...
    require '/Users/thomas.mcinally/Documents/stockprice-CPP/libs/openssl-3.2.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/thomas.mcinally/Documents/stockprice-CPP/libs/openssl-3.2.1/test/fips-and-base.cnf';
    shift;
